...
mod <- bayesSNPassoc(group = y, data=SNPs, sep.allele="", n.cores=3)
```
...
Then the function calls `rjags` trough `dclone` package using the function `jags.parfit` to estimate model parameters. The argument `n.cores` indicates the number of cores used to fit the model if multiple processors are available. By default `n.cores=1`. 
